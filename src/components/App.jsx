    ...
    if (prevSearch !== newSearch || prevPage !== newPage) {
      ...
      try {
        const response = await axios.get(
          `/?q=${newSearch}&page=${newPage}&key=29476231-74111085bca249ef803458946&image_type=photo&orientation=horizontal&per_page=12`
        );
    ...
    return (
      <>
        ...
        {(items.length === 12 || items.length > 12) && (
          <LoadMoreBtn onClick={this.ClickLoadBtn} />
        )}
        {showModal && (
